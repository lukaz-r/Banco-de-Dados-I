 ...
 * @author CUZIM
 */
public class PesquisaAvaliacao extends Application {
    ...
    public void start(Stage stage) throws Exception {
        //
    Parent root = FXMLLoader.load(getClass().getResource("/View/FXMLPesq_avaliacao.fxml"));
    ...
    public static void setStage(Stage aStage) {
        PesquisaAvaliacao.stage = aStage;
    }
}
